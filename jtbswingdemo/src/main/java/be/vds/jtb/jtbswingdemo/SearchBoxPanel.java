	...
	private Component createLine1() {
		SearchBox box = new SearchBox() {
			...
			protected void lookup() {
				JOptionPane.showMessageDialog(SearchBoxPanel.this,
		...
		GridBagConstraints c = new GridBagConstraints();
		c.insets = new Insets(0, 0, 0, 0);
		GridBagLayoutManager.addComponent(p, new JLabel("A Box Stretchable"), c, 0, 0, 1, 1,
				0, 0, GridBagConstraints.NONE, GridBagConstraints.CENTER);
		
		GridBagLayoutManager.addComponent(p,box, c, 1,
