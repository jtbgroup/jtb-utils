...
public class WizardController implements ActionListener {
    ...
    void resetButtonsToPanelRules() {
        ...
        model.setCancelButtonText(Wizard.getCancelText());
        ...
        model.setBackButtonText(Wizard.getBackText());
        ...
        if (descriptor.getNextPanelDescriptor() instanceof WizardPanelDescriptor.FinishIdentifier) {
            model.setNextFinishButtonText(Wizard.getFinishText());
            model.setNextFinishButtonIcon(Wizard.FINISH_ICON);
        } else {
            model.setNextFinishButtonText(Wizard.getNextText());
