...
/**
 * A localizable {@link JRadioButton}
 * 
 * @author Pierre Jeanmenne
 * @version 1.0
 * @created 05-11-2008
 */
public class I18nRadioButton extends JRadioButton implements I18nComponent {

	/** The Serial Version UID for I18nRadioButton */
	...
	/** The key used by the resource manager to find the tooltip text to display on the component */
	...
	/**
	 * Creates an I18nRadioButton
	 */
	public I18nRadioButton(){
		super();
	}
	
	/**
	 * Creates an I18nRadioButton with a localized text
	 ...
	 */
	public I18nRadioButton(String textBundleKey){
		this(textBundleKey, false);
	}
	
	/**
	 * Creates an I18nRadioButton with the specified icon
	 * @param icon - the icon to display for the component
     */
	public I18nRadioButton(Icon icon){
		super(icon);
	}
	
	/**
	 * Creates an I18nRadioButton form the properties of the given action
	 * @param action - the button action
     */
	public I18nRadioButton(Action action){
		super(action);
	}
	 ...
	 * @param textBundleKey - the key used by the resource manager to find the text
	 * 						  to display on the component in a resource bundle
	 * @param selected 		- <code>true</code> if the button must be initially selected,
     * 					  	  <code>false</code> otherwise
	 */
	public I18nRadioButton(String textBundleKey, boolean selected){
		this(textBundleKey, null, selected);
	}
	
	/**
	 * Creates an I18nRadioButton with the specified icon, and with a given initial selection state.
	 * 
	 * @param icon 		- the icon to display for the component
     * @param selected 	- <code>true</code> if the button must be initially selected,
     * 					  <code>false</code> otherwise
	 */
	public I18nRadioButton(Icon icon, boolean selected){
		super(icon, selected);
	}
	
	/**
	 * Creates an I18nRadioButton with a localized text and the specified icon.
	 * 
	 * @param textBundleKey - the key used by the resource manager to find the text
	 * 						  to display on the component in a resource bundle
	 * @param icon 			- the icon to display for the component
     */
	public I18nRadioButton(String textBundleKey, Icon icon){
		this(textBundleKey, icon, false);
	}
	
	/**
	 * Creates an I18nRadioButton with  a localized text, a specified icon,
	 * and a given initial selection state.
	 * 
	 * @param textBundleKey - the key used by the resource manager to find the text
	 * 						  to display on the component in a resource bundle
	 * @param icon 			- the icon to display for the component
     ...
     * 					  	  <code>false</code> otherwise
	 */
	public I18nRadioButton(String textBundleKey, Icon icon, boolean selected){
		super(icon, selected);
