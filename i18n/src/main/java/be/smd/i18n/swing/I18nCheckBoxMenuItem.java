 ...
 * @created 09-03-2009
 */
public class I18nCheckBoxMenuItem extends JCheckBoxMenuItem implements I18nComponent{
    
    /** The serial version UID for {@link I18nCheckBoxMenuItem} */
	...
	/**
     * Creates an initially unselected I18nCheckBoxMenuItem with no set text or icon.
     */
    public I18nCheckBoxMenuItem(){
        super();
    }
	
	/**
     * Creates a I18nCheckBoxMenuItem with the key that will be used by the resource manager<br/>
     * to find the text to display on the component, and initially unselected.
     * 
     * @param textBundleKey - the key in a resource bundle where to find the text to display on the menu item
     */
    public I18nCheckBoxMenuItem(String textBundleKey){
        this(textBundleKey, null, false);
    }
    
    /**
     * Creates a I18nCheckBoxMenuItem with the key that will be used by the resource manager<br/>
     * to find the text to display on the component, and with a given selection state.
     * 
     * @param textBundleKey - the key in a resource bundle where to find the text to display on the menu item
     * @param selected		- <code>true</code> if the menu item must be selected, <code>false</code> otherwise.
     */
    public I18nCheckBoxMenuItem(String textBundleKey, boolean selected){
        this(textBundleKey, null, selected);
    }
    
    /**
     * Creates a I18nCheckBoxMenuItem with an icon, and initially unselected<br/>
     * @param icon - the icon to display on the menu item
     */
    public I18nCheckBoxMenuItem(Icon icon){
        super(icon);
    }
    
    /**
     * Creates a I18nCheckBoxMenuItem with the key that will be used by the resource manager<br/>
     * to find the text to display on the component, an icon, and a given initial selection state<br/>
     * @param textBundleKey - the key in a resource bundle where to find the text to display on the menu item
     * @param icon 			- the icon to display on the menu item
     * @param selected		- <code>true</code> if the menu item must be selected, <code>false</code> otherwise.
     */
    public I18nCheckBoxMenuItem(String textBundleKey, Icon icon, boolean selected){
        this(icon);
    ...
    /**
     * Creates an I18nCheckBoxMenuItem whose properties are taken from the Action supplied.
     * @param action - the supplied action
     */
    public I18nCheckBoxMenuItem(Action action){
    	super(action);
    }
